...
#! adding the prompt attention mechanism, the prompt tokens cannot attend other tokens except prompt tokens, only can be attened by other tokens
import copy
import logging
