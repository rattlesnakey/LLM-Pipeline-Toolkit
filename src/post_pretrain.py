...
class DataArguments:
    ...
    prompt_type: str = field(default='origin', metadata={"help": "prompt type to use"})
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    #! Post pretrain
    # post_pretrain: bool = field(default=True, metadata={"help": "Post-pretraining or not"})
...
class IterSupervisedDataset(IterableDataset):
    ...
    def add_prompt(self, line):
        ...
        #! pretraining, instruction as en (zh), output as zh (en)
