...
# DATASETS=('test_pipeline_data.json')
# 'self_instruct_5000.json'
DATASETS=('self_instruct_5000_jsonlines.jsonl')
...
do
    ...
    deepspeed --num_gpus=8 --master_port=50002 src/official_largedata_train.py \
        --deepspeed deepspeed_zero3_offload_nvme_config.json \
