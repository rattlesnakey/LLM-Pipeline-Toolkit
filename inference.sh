...
# TEST_FILE_PATH=/workspace/share_916081/effidit_shared_data/chillzhang/datas/self-instruct/predictions/text-davinci-003_predictions.jsonl
# TEST_FILE_PATH=/apdcephfs/share_916081/effidit_shared_data/chillzhang/datas/self-instruct/predictions/text-davinci-003_predictions.jsonl
TEST_FILE_PATH=/apdcephfs/share_916081/effidit_shared_data/chillzhang/datas/belle/zh_seed_tasks_jsonlines.jsonl
# TEST_FILE_PATH=/apdcephfs/share_916081/effidit_shared_data/chillzhang/datas/en_zh_seed_task/en_zh_seed_tasks.jsonl
DATA_TYPE=zh_seed_task #! or zh_seed_task, self-instruct
OUTPUT_FILE_DIR=${PRETRAINED_MODEL_PATH}/predictions/${DATA_TYPE}
mkdir -p ${OUTPUT_FILE_DIR}

OUTPUT_FILE_PATH=${OUTPUT_FILE_DIR}/${MODEL_TYPE}_prediction.jsonl


# LOG_PATH=/workspace/share_916081/effidit_shared_data/chillzhang/projects/LLM_inference/logs/inference/${DATA_TYPE}

LOG_PATH=/apdcephfs/share_916081/effidit_shared_data/chillzhang/projects/LLM_inference/logs/inference/${DATA_TYPE}
...
RUN_NAME=${MODEL_NAME}-${DATA_TYPE}-temperature_${TEMPERATURE}-topk_${TOP_K}-topp_${TOP_P}-repetition_${REPETITION_PENALTY}-beams_${NUM_BEAMS}.log
...
# python -u
deepspeed --include=localhost:2 src/inference.py \
