...
from utils import batch_generate, PROMPT_DICT, LANGS
...
def batch_inference(test_file_path:str, output_file_path:str, dataset_type='self-instruct'):
...
if __name__ == '__main__':
    ...
    batch_inference(args.test_file_path, args.output_file_path, args.dataset_type)
    logger.info('Done')
